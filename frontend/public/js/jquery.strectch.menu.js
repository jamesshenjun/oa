...
*/
		...
		if(AccordionHeaderSelector.hasClass("compressed")){
			...
			AccordionHeaderSelector.siblings(".AccordionHeader").each(function(){
				...
				if(AttrDisplay=='block'){
					$(this).next(".AccordionContent").slideToggle(300);
				}
			...
			AccordionHeaderSelector.next(".AccordionContent").slideToggle(300);
    ...
    MenuSelector.find(".AccordionContent ul li a").click(function(event){
