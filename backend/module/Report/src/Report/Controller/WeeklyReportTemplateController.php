...
class WeeklyReportTemplateController extends ReportTemplateBaseController {
	
	// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~周报部分~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	/**
	 * 周报模板列表
	 */
	public function showWeeklyReportTemplateListAction() {
		// 处理post过来的数据
		$queryData = $this->FormatReportTemplatePostdata ( 'w' );
		// 处理分页事物
	...
	public function showWeeklyReportTemplateAddAction() {
	...
	public function showWeeklyReportTemplatePreviewAction() {
		$id = $_GET ['id'];
		// 查询模板表信息
	...
	public function showWeeklyReportTemplateEditAction() {
		$id = $_GET ['id'];
	...
	public function checkWeeklyReportTemplateEditAction() {
...
// 			print_r($postData);exit;
	...
	public function checkWeeklyReportTemplateDeleteAction() {
		$tid = $_GET ['id'];
		$reportTemplateInfoModel = $this->reportTemplateInfoModel;
	...
	public function checkWeeklyReportTemplateAddAction() {
